...
/**
 * Client-side wrapper for ClerkProvider
 * Prevents server-side API access during static generation
 * Only renders ClerkProvider in the browser
 */
export default function ClerkProviderWrapper({
  ...
  // Don't render ClerkProvider during static generation
  if (!mounted) {
    return <>{children}</>
  }
